  ...
  return skills.map((skill: ISkills) => {
    return (
      <Link
        ...
        href={skill.href}
        target="_blank"
        className="mb-3 flex items-center justify-center text-sm text-purple-900 transition duration-300 hover:text-purple-logo focus:outline-none dark:text-purple-50 sm:text-base lg:text-lg"
      >
...
export default function AboutSkills({ type }: { type: SkillsEnum }) {
  ...
  return (
    ...
    >
      ...
      <div className="h-fit overflow-y-scroll overscroll-y-none rounded-lg bg-purple-100/30 px-2 py-1 backdrop-blur-sm scrollbar scrollbar-thumb-purple-900 scrollbar-track-rounded-full scrollbar-thumb-rounded-full scrollbar-w-1.5 dark:bg-purple-900/30 dark:scrollbar-thumb-purple-logo lg:h-72">
